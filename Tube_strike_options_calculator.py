...
def calculator(distance, bus_drive, bus_walk):
    ...
    t_bus_walk_part = bus_walk / walk_speed
    t_bus_drive = bus_drive / bus_speed
    t_bus_total = t_bus_walk_part + t_bus_drive
    
    if t_walk <= t_bus_total:
        return "Walk"
    else:
        return "Bus"