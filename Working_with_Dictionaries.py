...
def inf_database(range_, str_, val):
    l = ["equals to", "higher than", "lower than", "higher and equals to", "lower and equals to"]
    if str_ not in l:
    ...
    for i in range(start, end + 1):
        try:
            if str_ == "equals to" and A001055[i] == val:
                res.append(i)
            elif str_ == "higher than" and A001055[i] > val:
                res.append(i)
            elif str_ == "lower than" and A001055[i] < val:
                res.append(i)
            elif str_ == "higher and equals to" and A001055[i] >= val:
                res.append(i)
            elif str_ == "lower and equals to" and A001055[i] <= val:
                res.append(i)
        except KeyError:
            continue
