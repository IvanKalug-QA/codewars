...
# They need you to write a function, greet_jedi(), which takes two arguments
# (a first name and a last name), works out the corresponding Jedi name, and returns a string greeting the Jedi.
#
...
# Note the capitalization: the first letter of each name is capitalized.
# Your input may or may not be capitalized. Your function should handle it and return
# the Jedi name in the correct case no matter what case the input is in:
#
...
def greet_jedi(first, last):
    n = last[:3].capitalize() + first[:2].capitalize()
    return f'Greetings, master {n}'