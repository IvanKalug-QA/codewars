# n this kata, you will write a function that receives an array of string and returns a string that is either 'naughty' or 'nice'. Strings that start with the letters b, f, or k are naughty. Strings that start with the letters g, s, or n are nice. Other strings are neither naughty nor nice.
#
...
def what_list_am_i_on(actions):
    ...
    for i in actions:
        if i[0] in "bfk":
            ...
            result.append(True)
    return "nice" if all(result) and result else "naughty"